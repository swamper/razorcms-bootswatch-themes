...
<html xmlns:ng="http://angularjs.org" id="ng-app">
	<head>
		...
		<link type="text/css" rel="stylesheet" href="<?php echo RAZOR_BASE_URL ?>extension/theme/swamper/bootswatch-superhero/style/style.css">
		...
		<!--[if IE 9]><link type="text/css" rel="stylesheet" href="<?php echo RAZOR_BASE_URL ?>extension/theme/swamper/bootswatch-superhero/style/style_ie9.css"><![endif]-->
		<!--[if IE 8]><link type="text/css" rel="stylesheet" href="<?php echo RAZOR_BASE_URL ?>extension/theme/swamper/bootswatch-superhero/style/style_ie8.css"><![endif]-->
	</head>
			...
			<div class="template-footer">
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-sm-4">
							<div class="template-footer-content">
								<?php $this->content("footer", 2); ?>
							</div>
						</div>
						<div class="col-sm-4">
							<div class="template-footer-content">
								<?php $this->content("footer", 3); ?>
							</div>
						</div>
					</div>
				</div>
